...
describe 'Project' do
  ...
  context "Kickbox Importer While Insertion of Existing Lead Which is Owned By Susie Romero from Kickbox and assign to the Particular Campaign Based on Lead Owner Criterias", '317' => 'true' do
    ...
    it 'To Check Journey Created While Importing Existing Contact Which is Owned By Non Susie Romero Where Activity is not present and existing journey is not present where Generate Journey on UI is Checked & in CSV is Blank and assign to the Campaign', :'2673' => 'true' do
      begin
    ...
    it 'To Check Journey  Created While Importing Existing Contact Which is Owned By Non Susie Romero Where Activity is not present and existing journey is not present where Generate Journey on UI is UnChecked & in CSV is True and assign to the Campaign.', :'2674' => 'true' do
      begin
        @helper.addLogs("[Step ]  : Getting existing contact")
        @pageObject.instance_variable_get(:@testDataJSON)['Lead'][0]['Generate_Journey__c'] = true
        contactInfo = @pageObject.getExistingContact("",false,false)
    ...
    it 'To Check Journey  Created While Importing Existing Contact Which is Owned By Non Susie Romero Where Activity is not present and existing journey is present where Generate Journey on UI is Checked & in CSV is Blank and assign to the Campaign', :'2677' => 'true' do
      begin
        @helper.addLogs("[Step ]  : Getting existing contact")
        @pageObject.instance_variable_get(:@testDataJSON)['Lead'][0]['Generate_Journey__c'] = true
    ...
    it 'To Check Journey Created While Importing Existing Contact Which is Owned By Non Susie Romero Where Activity & Existing Journey is Present, Generate Journey in UI is Checked and in CSv it is Blank and assign to the Campaign based on Lead Owner.', :'2679' => 'true' do
      begin
        @helper.addLogs("[Step ]  : Getting existing contact")
        @pageObject.instance_variable_get(:@testDataJSON)['Lead'][0]['Generate_Journey__c'] = true
    ...
    it 'To Check Journey not Created While Importing Existing Contact Which is Owned By Non Susie Romero Where Activity is not present and existing journey is not present where Generate Journey on UI is Unchecked & in CSV is False and assign to the Campaign.', :'2676' => 'true' do
      begin
        @helper.addLogs("[Step ]  : Getting existing contact")
        @pageObject.instance_variable_get(:@testDataJSON)['Lead'][0]['Generate_Journey__c'] = true
        contactInfo = @pageObject.getExistingContact("",true,true)
  ...
  context "Kickbox Importer While Insertion of Existing Lead Which is Owned By Susie Romero from Kickbox and assign to the Particular Campaign Based on Email Address Criterias",'325'=>'true' do
    ...
    it 'To Check Journey Created While Importing Existing Contact Which is Owned By Non Susie Romero Where Activity is not present and existing journey is not present where Generate Journey on UI is Checked & in CSV is Blank and assign to the Campaign.', :'2732' => 'true' do
      begin
        @helper.addLogs("[Step ]  : Getting existing contact")
        @pageObject.instance_variable_get(:@testDataJSON)['Lead'][0]['Generate_Journey__c'] = true
        contactInfo = nil
    ...
    it 'To Check Journey Created While Importing Existing Contact Which is Owned By Non Susie Romero Where Activity is not present and existing journey is not present where Generate Journey on UI is UnChecked & in CSV is True and assign to the Campaign.', :'2733' => 'true' do
      begin
        @helper.addLogs("[Step ]  : Getting existing contact")
        @pageObject.instance_variable_get(:@testDataJSON)['Lead'][0]['Generate_Journey__c'] = true
        contactInfo = @pageObject.getExistingContact("",false,false)
    ...
    it 'To Check Journey Created While Importing Existing Contact Which is Owned By Non Susie Romero Where Activity is not present and existing journey is present where Generate Journey on UI is Checked & in CSV is Blank and assign to the Campaign.', :'2735' => 'true' do
      begin
        @helper.addLogs("[Step ]  : Getting existing contact")
        @pageObject.instance_variable_get(:@testDataJSON)['Lead'][0]['Generate_Journey__c'] = true
        contactInfo = @pageObject.getExistingContact("",true,false)
    ...
    it 'To Check Journey Created While Importing Existing Contact Which is Owned By Non Susie Romero Where Activity is  present and existing journey is present where Generate Journey on UI is Checked & in CSV is Blank and assign to the Campaign.', :'2737' => 'true' do
      begin
        @helper.addLogs("[Step ]  : Getting existing contact")
        @pageObject.instance_variable_get(:@testDataJSON)['Lead'][0]['Generate_Journey__c'] = true
        contactInfo = @pageObject.getExistingContact("",true,true)
    ...
    it 'To Check Journey not Created While Importing Existing Contact Which is Owned By Non Susie Romero Where Activity is not present and existing journey is not present where Generate Journey on UI is UnChecked & in CSV is false and assign to the Campaign.', :'2734' => 'true' do
      begin
        @helper.addLogs("[Step ]  : Getting existing contact")
        @pageObject.instance_variable_get(:@testDataJSON)['Lead'][0]['Generate_Journey__c'] = true
        contactInfo = @pageObject.getExistingContact("",true,true)
  ...
  context "Kickbox Importer While Insertion of Existing Contact which is Owned by Non Susie Romero from Kickbox and assign to the Particular Campaign Based on City Criterias",'325'=>'true' do
    before(:all) do
      @testDataJSON['Campaign'][0]['Lead Owner'] = ''
      @testDataJSON['Campaign'][0]['Email Address'] = 'vikhroliwest@wework.co.in'
      @testDataJSON['Campaign'][0]['City'] = ''
    ...
    it 'To Check Journey Created While Importing Existing Contact Which is Owned By Non Susie Romero Where Activity is not present and existing journey is not present where Generate Journey on UI is Checked & in CSV is Blank and assign to the Campaign.', :'2738' => 'true' do
      begin
        @helper.addLogs("[Step ]  : Getting existing contact")
        @pageObject.instance_variable_get(:@testDataJSON)['Lead'][0]['Generate_Journey__c'] = true
        contactInfo = nil
    ...
    it 'To Check Journey Created While Importing Existing Contact Which is Owned By Non Susie Romero Where Activity is not present and existing journey is not present where Generate Journey on UI is UnChecked & in CSV is True and assign to the Campaign.', :'2741' => 'true' do
      begin
        @helper.addLogs("[Step ]  : Getting existing contact")
        @pageObject.instance_variable_get(:@testDataJSON)['Lead'][0]['Generate_Journey__c'] = true
        contactInfo = @pageObject.getExistingContact("",false,false)
    ...
    it 'To Check Journey Created While Importing Existing Contact Which is Owned By Non Susie Romero Where Activity is not present and existing journey is present where Generate Journey on UI is Checked & in CSV is Blank and assign to the Campaign.', :'2743' => 'true' do
      begin
        @helper.addLogs("[Step ]  : Getting existing contact")
        @pageObject.instance_variable_get(:@testDataJSON)['Lead'][0]['Generate_Journey__c'] = true
        contactInfo = @pageObject.getExistingContact("",true,false)
    ...
    it 'To Check Journey Created While Importing Existing Contact Which is Owned By Non Susie Romero Where Activity is  present and existing journey is present where Generate Journey on UI is Checked & in CSV is Blank and assign to the Campaign.', :'2744' => 'true' do
      begin
        @helper.addLogs("[Step ]  : Getting existing contact")
        @pageObject.instance_variable_get(:@testDataJSON)['Lead'][0]['Generate_Journey__c'] = true
        contactInfo = @pageObject.getExistingContact("",true,true)
    ...
    it 'To Check Journey not Created While Importing Existing Contact Which is Owned By Non Susie Romero Where Activity is not present and existing journey is not present where Generate Journey on UI is UnChecked & in CSV is false and assign to the Campaign.', :'2742' => 'true' do
      begin
        @helper.addLogs("[Step ]  : Getting existing contact")
        @pageObject.instance_variable_get(:@testDataJSON)['Lead'][0]['Generate_Journey__c'] = true
        contactInfo = @pageObject.getExistingContact("",true,true)
  ...
  context "Kickbox Importer While Insertion of Existing Contact which is Owned by Non Susie Romero from Kickbox and assign to the Particular Campaign Based if No criteria is Matched",'325'=>'true' do
    before(:all) do
      @testDataJSON['Campaign'][0]['Lead Owner'] = ''
      @testDataJSON['Campaign'][0]['Email Address'] = 'vikhroliwest@wework.co.in'
      @testDataJSON['Campaign'][0]['City'] = ''
    ...
    it 'To Check Journey Created While Importing Existing Contact Which is Owned By Non Susie Romero Where Activity is not present and existing journey is not present where Generate Journey on UI is Checked & in CSV is Blank and assign to the Campaign.', :'2746' => 'true' do
      begin
        @helper.addLogs("[Step ]  : Getting existing contact")
        @pageObject.instance_variable_get(:@testDataJSON)['Lead'][0]['Generate_Journey__c'] = true
        contactInfo = nil
    ...
    it 'To Check Journey Created While Importing Existing Contact Which is Owned By Non Susie Romero Where Activity is not present and existing journey is not present where Generate Journey on UI is UnChecked & in CSV is True and assign to the Campaign.', :'2748' => 'true' do
      begin
        @helper.addLogs("[Step ]  : Getting existing contact")
        @pageObject.instance_variable_get(:@testDataJSON)['Lead'][0]['Generate_Journey__c'] = true
        contactInfo = @pageObject.getExistingContact("",false,false)
    ...
    it 'To Check Journey Created While Importing Existing Contact Which is Owned By Non Susie Romero Where Activity is not present and existing journey is present where Generate Journey on UI is Checked & in CSV is Blank and assign to the Campaign.', :'2752' => 'true' do
      begin
        @helper.addLogs("[Step ]  : Getting existing contact")
        @pageObject.instance_variable_get(:@testDataJSON)['Lead'][0]['Generate_Journey__c'] = true
        contactInfo = @pageObject.getExistingContact("",true,false)
    ...
    it 'To Check Journey Created While Importing Existing Contact Which is Owned By Non Susie Romero Where Activity is  present and existing journey is present where Generate Journey on UI is Checked & in CSV is Blank and assign to the Campaign.', :'2764' => 'true' do
      begin
        @helper.addLogs("[Step ]  : Getting existing contact")
        @pageObject.instance_variable_get(:@testDataJSON)['Lead'][0]['Generate_Journey__c'] = true
        contactInfo = @pageObject.getExistingContact("",true,true)
    ...
    it 'To Check Journey not Created While Importing Existing Contact Which is Owned By Non Susie Romero Where Activity is not present and existing journey is not present where Generate Journey on UI is UnChecked & in CSV is false and assign to the Campaign.', :'2750' => 'true' do
      begin
        @helper.addLogs("[Step ]  : Getting existing contact")
        @pageObject.instance_variable_get(:@testDataJSON)['Lead'][0]['Generate_Journey__c'] = true
        contactInfo = @pageObject.getExistingContact("",true,true)
