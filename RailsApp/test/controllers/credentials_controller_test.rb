...
class CredentialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create credential" do
    assert_difference('Credential.count') do
      post credentials_url, params: { credential: { hostName: @credential.hostName, password: @credential.password, type: @credential.type, username: @credential.username } }
    end
  ...
  test "should update credential" do
    patch credential_url(@credential), params: { credential: { hostName: @credential.hostName, password: @credential.password, type: @credential.type, username: @credential.username } }
