...
class EnvironmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create environment" do
    assert_difference('Environment.count') do
      post environments_url, params: { environment: { name: @environment.name, parameters: @environment.parameters } }
    end
  ...
  test "should update environment" do
    patch environment_url(@environment), params: { environment: { name: @environment.name, parameters: @environment.parameters } }
