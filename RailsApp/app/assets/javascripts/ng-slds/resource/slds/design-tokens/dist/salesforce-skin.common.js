...
module.exports = {
    ...
    // The color of the mask overlay that provides @@users feedback on interaction.
    ...
    // Selected input field (when @@users has clicked or tabbed into field)
    ...
    // Background color for UI elements related to the concept of an external @@users or customer.
    ...
    // Border color for UI elements related to the concept of an external @@users or customer.
    ...
    bannerUserDefaultImage: "/assets/images/themes/oneSalesforce/banner-@@users-default.png",
