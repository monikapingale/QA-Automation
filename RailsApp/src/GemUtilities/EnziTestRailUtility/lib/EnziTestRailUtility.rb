...
#testRailUtility = EnziTestRailUtility::TestRailUtility.new("team-qa@enzigma.com","ub/RF5uzEdPG4DA1KEGu-4bZg0swC5UmvahYeMv0K")
...
#puts "res :: #{response}"
# grant_type=password&client_id=3MVG9AzPSkglhtpvenc1ubvIHNqdSv2B8w9bFU2hNfvAOfxt5ri2SCQo_M.lflR7dukJ5s9LtXu.eZ3KzbmRO&client_secret=8952510748675479529&username=joinus@wework.com.staging&password=PkskoZEHTy67nB&redirect_uri=https://test.salesforce.com/services/oauth2/callback
